   ...
   <main class="main-content">
    ...
    <h2>Tra cứu nhập - xuất - tồn</h2>
      ...
      <input type="date" id="to-date" />
            ...
            <button class="btn-primary">Tra cứu N-X-T</button>
   </div>
    ...
    <h2>Kết quả tra cứu</h2>
     ...
     <div class="result-row">
      <span class="label">Tồn đầu kỳ:</span>
      <span class="value">30 cái</span>
     </div>
     <div class="result-row">
      <span class="label">Nhập:</span>
      <span class="value">10 cái</span>
     </div>
     <div class="result-row">
      <span class="label">Xuất:</span>
      <span class="value">5 cái</span>
     </div>
     <div class="result-row">
      <span class="label">Tồn cuối kỳ:</span>
